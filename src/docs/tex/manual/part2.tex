...
DMDAVecRestoreArray(DM da,Vec global,&f);
\end{lstlisting}
See \href{https://www.mcs.anl.gov/petsc/petsc-current/src/snes/examples/tutorials/ex5.c.html}{\trl{$PETSC_DIR/src/snes/examples/tutorials/ex5.c}} for a
complete example and see \href{https://www.mcs.anl.gov/petsc/petsc-current/src/snes/examples/tutorials/ex19.c.html}{\trl{$PETSC_DIR/src/snes/examples/tutorials/ex19.c}} for an
...
The example
\href{https://www.mcs.anl.gov/petsc/petsc-current/src/snes/examples/tutorials/ex5.c.html}{\trl{$PETSC_DIR/src/snes/examples/tutorials/ex5.c}}
illustrates the use of a distributed array in the solution of
a nonlinear problem.  The analogous Fortran program is
\href{https://www.mcs.anl.gov/petsc/petsc-current/src/snes/examples/tutorials/ex5f.F90.html}{\trl{$PETSC_DIR/src/snes/examples/tutorials/ex5f.F90}};
...
See \href{https://www.mcs.anl.gov/petsc/petsc-current/src/ksp/ksp/examples/tutorials/ex5.c.html}{\trl{$PETSC_DIR/src/ksp/ksp/examples/tutorials/ex5.c}} for a simple example of
...
See \href{https://www.mcs.anl.gov/petsc/petsc-current/src/snes/examples/tutorials/ex28.c.html}{\trl{$PETSC_DIR/src/snes/examples/tutorials/ex28.c}} for a simple example using this interface.
...
examples \href{https://www.mcs.anl.gov/petsc/petsc-current/src/ksp/ksp/examples/tutorials/ex7.c.html}{\trl{$PETSC_DIR/src/ksp/ksp/examples/tutorials/ex7.c}}
or \href{https://www.mcs.anl.gov/petsc/petsc-current/src/ksp/ksp/examples/tutorials/ex7.c.html}{\trl{$PETSC_DIR/src/ksp/ksp/examples/tutorials/ex8.c}}.
...
Examples of the described PCGASM usage can be found in \href{https://www.mcs.anl.gov/petsc/petsc-current/docs/manualpages/PC/PCGASM.html}{\trl{${PETSC_DIR}/src/ksp/ksp/examples/tutorials/ex62.c}}.
...
PETSc  has a preliminary interface to Nvidia's AMGx solver -- \trl{-pc_type amgx} or  \lstinline{PCSetType(pc,PCAMGX)}.
AMGx does not seem to have a coarse grid solver.
This results in low modes not being solved efficiently as the number
of MPI processes is increased.
The PETSc parameter interface to AMGx is fragile and not flexible, one must specify an AMGx input file with \trl{-pc_amgx_json path-to-intput-file}.
The classical AMG method is recommended (eg, -pc_amgx_json
AMG_CLASSICAL_AGGRESSIVE_L1_RT6.json).
Sample input files are located in share/petsc/amgx and PETSc will add this prefix if the provide full path is not found.
The classical AMG solver is recommended (AMG_CLASSICAL_AGGRESSIVE_L1_RT6.json).
This input file is for a complete CG/AMG solver within AMGx and so one should use \trl{-ksp_type preonly -ksp_max_it 1}.
...
For further details, see the example \href{https://www.mcs.anl.gov/petsc/petsc-current/src/ksp/ksp/examples/tutorials/ex59.c}{\trl{${PETSC_DIR}/src/ksp/ksp/examples/tutorials/ex59.c}} and the online documentation for \lstinline{PCBDDC}.
...
are \href{https://www.mcs.anl.gov/petsc/petsc-current/src/ts/examples/tutorials/extchem.c.html}{\trl{$PETSC_DIR/src/ts/examples/tutorials/extchem.c}}
and \href{https://www.mcs.anl.gov/petsc/petsc-current/src/ts/examples/tutorials/exchemfield.c.html}{\trl{$PETSC_DIR/src/ts/examples/tutorials/exchemfield.c}}.
...
To provide a better understanding of the use of the adjoint solvers, we introduce a simple example, corresponding to \href{https://www.mcs.anl.gov/petsc/petsc-current/src/ts/examples/tutorials/power_grid/ex3adj.c.html}{\trl{${PETSC_DIR}/src/ts/examples/tutorials/power_grid/ex3adj.c}}.
...
\item a discrete adjoint sensitivity using explicit time stepping
  methods \href{https://www.mcs.anl.gov/petsc/petsc-current/src/ts/examples/tutorials/ex16adj.c.html}{\trl{${PETSC_DIR}/src/ts/examples/tutorials/ex16adj.c}},
\item a discrete adjoint sensitivity using implicit time stepping
  methods \href{https://www.mcs.anl.gov/petsc/petsc-current/src/ts/examples/tutorials/ex20adj.c.html}{\trl{${PETSC_DIR}/src/ts/examples/tutorials/ex20adj.c}},
\item an optimization using the discrete adjoint models of ERK
  \href{https://www.mcs.anl.gov/petsc/petsc-current/src/ts/examples/tutorials/ex16opt_ic.c.html}{\trl{${PETSC_DIR}/src/ts/examples/tutorials/ex16opt_ic.c}} and \href{https://www.mcs.anl.gov/petsc/petsc-current/src/ts/examples/tutorials/ex16opt_p.c.html}{\trl{${PETSC_DIR}/src/ts/examples/tutorials/ex16opt_p.c}},
\item an optimization using the discrete adjoint models of Theta
methods for stiff DAEs
    \href{https://www.mcs.anl.gov/petsc/petsc-current/src/ts/examples/tutorials/ex20opt_ic.c.html}{\trl{${PETSC_DIR}/src/ts/examples/tutorials/ex20opt_ic.c}} and \href{https://www.mcs.anl.gov/petsc/petsc-current/src/ts/examples/tutorials/ex20opt_p.c.html}{\trl{${PETSC_DIR}/src/ts/examples/tutorials/ex20opt_p.c}},
\item an ODE-constrained optimization using the discrete adjoint
  models of Theta methods for cost function with an integral term \href{https://www.mcs.anl.gov/petsc/petsc-current/src/ts/examples/tutorials/power_grid/ex3opt.c.html}{\trl{${PETSC_DIR}/src/ts/examples/tutorials/power_grid/ex3opt.c}},
\item a discrete adjoint sensitivity using \lstinline{TSCN} (Crank-Nicolson)
  methods for DAEs with discontinuities \href{https://www.mcs.anl.gov/petsc/petsc-current/src/ts/examples/tutorials/power_grid/stability/stability_9bus/ex9busadj.c.html}{\trl{${PETSC_DIR}/src/ts/examples/tutorials/power_grid/stability_9bus/ex9busadj.c}},
...
models of \lstinline{TSCN} (Crank-Nicolson) methods for cost function with an
    integral term \href{https://www.mcs.anl.gov/petsc/petsc-current/src/ts/examples/tutorials/power_grid/stability/stability_9bus/ex9busopt.c.html}{\trl{${PETSC_DIR}/src/ts/examples/tutorials/power_grid/stability_9bus/ex9busopt.c}},
  \item a discrete adjoint sensitivity using \lstinline{TSCN} methods for a
  PDE problem \href{https://www.mcs.anl.gov/petsc/petsc-current/src/ts/examples/tutorials/advection-diffusion-reaction/ex5adj.c.html}{\trl{${PETSC_DIR}/src/ts/examples/tutorials/advection-diffusion-reaction/ex5adj.c}}.
\end{itemize}
...
VecRestoreArray(u, &a);
\end{lstlisting}
This kind of calculation is used in \lstinline{TS} \href{https://www.mcs.anl.gov/petsc/petsc-current/src/ts/examples/tutorials/ex11.c.html}{\trl{$PETSC_DIR/src/ts/examples/tutorials/ex11.c}}.
...
corresponding to
\href{https://www.mcs.anl.gov/petsc/petsc-current/src/vec/vec/examples/tests/ex19f.F.html}{\trl{${PETSC_DIR}/src/vec/vec/examples/tests/ex19f.F}},
\href{https://www.mcs.anl.gov/petsc/petsc-current/src/vec/vec/examples/tutorials/ex4f.F.html}{\trl{${PETSC_DIR}/src/vec/vec/examples/tutorials/ex4f.F}},
\break
\href{https://www.mcs.anl.gov/petsc/petsc-current/src/sys/classes/draw/examples/tests/ex5f.F.html}{\trl{${PETSC_DIR}/src/sys/classes/draw/examples/tests/ex5f.F}}, and
\href{https://www.mcs.anl.gov/petsc/petsc-current/src/snes/examples/tutorials/ex1f.F90.html}{\trl{${PETSC_DIR}/src/snes/examples/ex1f.F90}}, respectively.  We also
...
For an example, see \href{https://www.mcs.anl.gov/petsc/petsc-current/src/dm/examples/tutorials/ex7.c.html}{\trl{${PETSC_DIR}/src/dm/examples/tutorials/ex7.c}}.
...
For an example, which includes sending data back to PETSc, see \href{https://www.mcs.anl.gov/petsc/petsc-current/src/vec/vec/examples/tutorials/ex42.c.html}{\trl{${PETSC_DIR}/src/vec/vec/examples/tutorials/ex42.c}} and the associated \trl{.m} file.
...
\href{https://www.mcs.anl.gov/petsc/petsc-current/src/ksp/ksp/examples/tutorials/ex10.c.html}{\trl{${PETSC_DIR}/src/ksp/ksp/examples/tutorials/ex10.c}}.
The code loads a
...
\href{https://www.mcs.anl.gov/petsc/petsc-current/src/ksp/ksp/examples/tutorials/ex10.c.html}{\trl{${PETSC_DIR}/src/ksp/ksp/examples/tutorials/ex10.c}} to
...
to PETSc objects. See \href{https://www.mcs.anl.gov/petsc/petsc-current/src/snes/examples/tutorials/ex5.c.html}{\trl{${PETSC_DIR}/snes/examples/tutorials/ex5.c}} and
\href{https://www.mcs.anl.gov/petsc/petsc-current/src/snes/examples/tutorials/ex5f.F90.html}{\trl{${PETSC_DIR}/snes/examples/tutorials/ex5f.F90}} for examples of user-defined application
...
The program \href{https://www.mcs.anl.gov/petsc/petsc-current/src/ksp/ksp/examples/tutorials/ex11.c.html}{\trl{${PETSC_DIR}/src/ksp/ksp/examples/tutorials/ex11.c}}
solves a linear system with a complex
coefficient matrix.  Its Fortran counterpart is
\href{https://www.mcs.anl.gov/petsc/petsc-current/src/ksp/ksp/examples/tutorials/ex11f.F90.html}{\trl{${PETSC_DIR}/src/ksp/ksp/examples/tutorials/ex11f.F90}}.
...
script:
\begin{bashlisting}
${PETSC_DIR}/${PETSC_ARCH}/tests/vec/vec/examples/tutorials/runex6.sh
\end{bashlisting}
...
\href{https://www.mcs.anl.gov/petsc/petsc-current/docs/developers.pdf}{Developer's Guide}.
